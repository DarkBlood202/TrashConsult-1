                ...
                <div className="card-body">
                    <form>
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-9 text-secondary">
                                <input type="text" className="form-control" name="telefonofijo" placeholder="123-4567" />
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-9 text-secondary">
                                <input type="text" className="form-control" name="telefonomovil" placeholder="987-654-321" />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-9 text-secondary">
                                <input type="text" className="form-control" name="web" placeholder="https://www.edupy.com" />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-4 text-secondary">
                                <a href="/" className="btn btn-danger px-4">Cancelar</a>
                            </div>
                        </div>
                    </form>
                </div>
